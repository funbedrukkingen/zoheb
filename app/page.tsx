    ...
    <main>
      <section className="hero" aria-labelledby="hero-title">
        ...
        <div className="hero__inner">
          <div className="badge"><span className="badge__dot" />Binnenkort: community website</div>
          ...
          <div className="actions">
            <a className="button button--primary" href="https://1drv.ms/f/c/e7fb91e43989f306/EgbziTnkkfsggOczCQAAAAABkLA_hUoRG5wlKm8zmOmIOQ?e=sPrztW" target="_blank" rel="noreferrer">Ga naar de gratis downloadmap</a>
